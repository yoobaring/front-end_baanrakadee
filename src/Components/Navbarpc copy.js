...
<div className="container-fluid p0">
  ...
  <nav>
    ...
    <ul id="respMenu" className="ace-responsive-menu text-right" data-menu-style="horizontal">
      ...
      <li className="list-inline-item list_s"><a href="#" className="btn flaticon-user" data-toggle="modal" data-target=".bd-example-modal-lg"> <span className="dn-lg">ล๊อกอิน/สมัครสมาชิก</span></a></li>
